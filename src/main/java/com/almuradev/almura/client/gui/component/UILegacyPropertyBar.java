...
public class UILegacyPropertyBar extends UIComponent<UILegacyPropertyBar> {
    ...
    public UILegacyPropertyBar(MalisisGui gui, GuiIcon symbolIcon) {
        super(gui);
    ...
    public UILegacyPropertyBar setRelativeColor(boolean relativeColor) {
    ...
    public UILegacyPropertyBar setColor(int color) {
        this.color = color;
        return this;
    }
    ...
    public UILegacyPropertyBar setAmount(float amount) {
        this.amount = amount;
        return this;
    }
