...
public class DynamicAboutMenu extends SimpleGui {
    ...
    public void construct() {
        ...
        String fieldText =
                ...
                + "\n\n"
                + Colors.GOLD + "Zidane" + Colors.RESET + " - Lead Developer & Founder of Sponge, Lead Developer of AlmuraDev, Former Developer for Spout."
                + "\n\n"
                ...
                + "\n\n"
                + Colors.GOLD + "Blood_" + Colors.RESET + " - Developer for Sponge, former Developer for Cauldron."
                + "\n\n"
