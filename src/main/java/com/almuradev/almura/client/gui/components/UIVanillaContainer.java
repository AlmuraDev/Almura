...
public class UIVanillaContainer extends UIBackgroundContainer {
    ...
    private void construct() {
        ...
        this.middleContentContainer.setClipContent(true);
        ...
        this.wrappingContainer.setBackgroundAlpha(0);
    ...
    public void draw(GuiRenderer renderer, int mouseX, int mouseY, float partialTick) {
        middleContentContainer.setSize(UIComponent.INHERITED, this.gui.height - 104);
