...
public class DynamicConfigurationMenu extends SimpleGui {
    ...
    public void construct() {
        ...
        final UILabel hudTypeLabel = new UILabel(this, EnumChatFormatting.WHITE + "HUD:");
        ...
        switch (Configuration.HUD_TYPE.toLowerCase(Locale.ENGLISH)) {
            case "almura":
        ...
        animalHeatCheckBox = new UICheckBox(this, EnumChatFormatting.WHITE + "Show Animal Names with Status");
        ...
        final UILabel chestRenderDistance = new UILabel(this, EnumChatFormatting.WHITE + "Chest Distance:");
        chestRenderDistance.setPosition(-55, padding * 2, Anchor.RIGHT | Anchor.TOP);

        final UILabel signRenderDistance = new UILabel(this, EnumChatFormatting.WHITE + "Sign Distance:");
        signRenderDistance.setPosition(-55, hudTypeLabel.getY() + (padding * 4), Anchor.RIGHT | Anchor.TOP);

        final UILabel itemFrameRenderDistance = new UILabel(this, EnumChatFormatting.WHITE + "Item Frame Distance:");
        ...
        almuraDebugGuiCheckBox = new UICheckBox(this, EnumChatFormatting.WHITE + "Enhanced F3 Debug Menu");
        ...
        chatNotificationCheckBox = new UICheckBox(this, EnumChatFormatting.WHITE + "Chat Notifications");
        ...
        optimizedLightingCheckbox = new UICheckBox(this, EnumChatFormatting.WHITE + "Optimized Lighting");
        ...
        debugModeCheckBox = new UICheckBox(this, EnumChatFormatting.WHITE + "Debug Mode (All)");
        ...
        debugLanguagesCheckBox = new UICheckBox(this, EnumChatFormatting.WHITE + "Debug Languages");
        ...
        debugPacksCheckBox = new UICheckBox(this, EnumChatFormatting.WHITE + "Debug Content Loading");
        ...
        debugMappingsCheckBox = new UICheckBox(this, EnumChatFormatting.WHITE + "Debug Entity / Item Mappings");
        ...
        debugRecipesCheckBox = new UICheckBox(this, EnumChatFormatting.WHITE + "Debug Recipe Loading");
