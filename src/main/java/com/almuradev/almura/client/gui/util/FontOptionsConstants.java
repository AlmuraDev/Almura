...
public final class FontOptionsConstants {
    ...
    public static final FontOptions FRO_COLOR_ORANGE_SCALE_080 = FontOptions.builder().from(FRO_COLOR_ORANGE).scale(0.8F).build();
    public static final FontOptions FRO_COLOR_ORANGE_SCALE_110 = FontOptions.builder().from(FRO_COLOR_ORANGE).scale(1.10F).build();
