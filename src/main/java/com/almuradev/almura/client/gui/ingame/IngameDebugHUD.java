...
public class IngameDebugHUD extends MalisisGui {
    ...
    public void updateWidgets() {
        ...
        zLoc.setText(ChatColor.GRAY + String.format("- z: %.5f (%d) // chunk: %d (%d)", this.mc.thePlayer.posZ, z, z >> 4, z & 15));
        directionLoc.setText(ChatColor.GRAY + cleanDirection);
        biomeName.setText(ChatColor.GRAY + chunk.getBiomeGenForWorldCoords(x & 15, z & 15, this.mc.theWorld.getWorldChunkManager()).biomeName);
