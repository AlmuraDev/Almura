...
public class AlmuraServerMenu extends AlmuraBackgroundGui {
    ...
    protected void setup() {
        ...
        almuraDevButton.setSize(180, 16);
        ...
        obsidianboxLiveButton.setPosition(0, getPaddedY(almuraDevButton, padding), Anchor.CENTER | Anchor.TOP);
        obsidianboxLiveButton.setSize(180, 16);
        ...
        window.add(logoImage, buildLabel, almuraLiveButton, almuraDevButton, obsidianboxLiveButton, anotherButton, backButton);
