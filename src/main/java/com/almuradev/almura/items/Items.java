...
import com.almuradev.almura.items.wands.FarmWand;
...
public class Items {
    ...
    public static final FarmWand WAND_FARM = new FarmWand("wand.farm", "Farm Wand", "farm_wand", Tabs.TAB_TOOLS);
    ...
    public static void fakeStaticLoad() {
        ...
        Almura.INTERNAL_PACK.addItem(WAND_FARM);
