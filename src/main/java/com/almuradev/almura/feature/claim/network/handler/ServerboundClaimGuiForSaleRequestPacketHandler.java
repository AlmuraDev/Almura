...
public final class ServerboundClaimGuiForSaleRequestPacketHandler implements MessageHandler<ServerboundClaimGuiForSaleRequestPacket> {
    ...
    @Inject
    public ServerboundClaimGuiForSaleRequestPacketHandler(@ChannelId(NetworkConfig.CHANNEL) final ChannelBinding.IndexedMessageChannel network, final
        ...
        if (side.isServer() && connection instanceof PlayerConnection && PacketUtil
            ...
            if (claim != null) {
                ...
                if (isOwner || isAdmin) {
                    ...
                    this.serverClaimManager.sendUpdateTo(player, claim, claim.getPlayers(), true);
