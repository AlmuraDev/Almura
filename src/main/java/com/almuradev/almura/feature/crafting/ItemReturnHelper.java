...
public class ItemReturnHelper implements Witness {
    ...
    public static void returnReusableItem(EntityPlayer player, String name, ItemStack currentStack, boolean debug) {
        ...
        switch (name.toUpperCase()) {
            ...
            case "ITEM.ALMURA.FOOD.FOOD.TOFU":
            case "ITEM.ALMURA.FOOD.FOOD.SOUTHERN_CORNCHIPS":
            case "ITEM.ALMURA.FOOD.FOOD.SOUTHERN_CHILI":
            case "ITEM.ALMURA.FOOD.FOOD.SNACK_CRACKERS":
            case "ITEM.ALMURA.FOOD.FOOD.BALLOFRICE":
            case "ITEM.ALMURA.FOOD.FOOD.BREAD_BUTTERMILKBISCUIT":
            case "ITEM.ALMURA.FOOD.FOOD.BREAKFAST_PANCAKE":
            case "ITEM.ALMURA.FOOD.FOOD.BREAKFAST_SCRAMBLEDEGGS":
            case "ITEM.ALMURA.FOOD.FOOD.BREAKFAST_WAFFLE":
            case "ITEM.ALMURA.FOOD.FOOD.CHEESE":
            case "ITEM.ALMURA.FOOD.FOOD.MAC_CHEESE":
            case "ITEM.ALMURA.FOOD.FOOD.SNACK_MASHEDPOTATOS":
            case "ITEM.ALMURA.NORMAL.INGREDIENT.VINEGAR":
            case "ITEM.ALMURA.NORMAL.INGREDIENT.DOUGH":
            case "ITEM.ALMURA.NORMAL.INGREDIENT.NOODLES":
            case "ITEM.ALMURA.NORMAL.INGREDIENT.YEAST":
            case "ITEM.ALMURA.NORMAL.INGREDIENT.BUTTER":
