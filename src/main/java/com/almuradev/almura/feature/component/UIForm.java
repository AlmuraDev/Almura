package com.almuradev.almura.feature.component;
...
public class UIForm extends UIBackgroundContainer {
     ...
     */
    public UIForm(SimpleContainerScreen parent, int width, int height) {
     ...
     */
    public UIForm(SimpleContainerScreen parent, int width, int height, String title) {
     ...
     */
    public UIForm(SimpleContainerScreen parent, int width, int height, String title, boolean showCloseButton) {
        super(parent);
    ...
    private class DraggableBackgroundContainer extends UIBackgroundContainer {
        ...
        public DraggableBackgroundContainer(SimpleContainerScreen parent, boolean showCloseButton) {
            super(parent);
    ...
    private class CloseButton extends UIButton {
        ...
        public CloseButton(SimpleContainerScreen gui) {
            super(gui, "");
            width = 23;
            height = 10;
            shape = new SimpleGuiShape();
            //icon = SimpleContainerScreen.ICON_CLOSE_NORMAL;
            //iconHovered = SimpleContainerScreen.ICON_CLOSE_HOVER;
            //iconPressed = SimpleContainerScreen.ICON_CLOSE_PRESSED;
        }
    }
}