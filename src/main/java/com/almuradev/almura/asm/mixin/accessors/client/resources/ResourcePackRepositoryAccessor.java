...
public interface ResourcePackRepositoryAccessor {
    ...
    @Mutable @Accessor("repositoryEntriesAll") List<ResourcePackRepository.Entry> accessor$getRepositoryEntriesAll();
    //public-f net.minecraft.client.resources.ResourcePackRepository field_110617_f # repositoryEntries
    @Mutable @Accessor("repositoryEntries") List<ResourcePackRepository.Entry> accessor$getRepositoryEntries();
}
