...
public interface FeatureConstants {
    ...
    double ONE_TRILLION = 1000000000000.0;
    ...
    static String withSuffix(final double value) {
        if (value < ONE_MILLION) {
            ...
            return FeatureConstants.CURRENCY_DECIMAL_FORMAT.format(value / ONE_MILLION) + "m";
        } else if (value < ONE_TRILLION) {
            return FeatureConstants.CURRENCY_DECIMAL_FORMAT.format(value / ONE_BILLION) + "b";
        } else {
            return FeatureConstants.CURRENCY_DECIMAL_FORMAT.format(value / ONE_TRILLION) + "t";
        }
    }
