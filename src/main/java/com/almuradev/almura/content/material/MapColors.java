...
public final class MapColors {
    ...
    public static final MapColor BLACK_STAINED_HARDENED_CLAY = DummyObjectProvider.createFor(MapColor.class, "black_stained_hardened_clay");

    public static final MapColor BLUE = DummyObjectProvider.createFor(MapColor.class, "blue");

    public static final MapColor BLUE_STAINED_HARDENED_CLAY = DummyObjectProvider.createFor(MapColor.class, "blue_stained_hardened_clay");

    public static final MapColor BROWN = DummyObjectProvider.createFor(MapColor.class, "brown");

    public static final MapColor BROWN_STAINED_HARDENED_CLAY = DummyObjectProvider.createFor(MapColor.class, "brown_stained_hardened_clay");
    ...
    public static final MapColor CYAN_STAINED_HARDENED_CLAY = DummyObjectProvider.createFor(MapColor.class, "cyan_stained_hardened_clay");
    ...
    public static final MapColor GRAY_STAINED_HARDENED_CLAY = DummyObjectProvider.createFor(MapColor.class, "gray_stained_hardened_clay");

    public static final MapColor GREEN = DummyObjectProvider.createFor(MapColor.class, "green");

    public static final MapColor GREEN_STAINED_HARDENED_CLAY = DummyObjectProvider.createFor(MapColor.class, "green_stained_hardened_clay");
    ...
    public static final MapColor LIGHT_BLUE_STAINED_HARDENED_CLAY = DummyObjectProvider.createFor(MapColor.class, "light_blue_stained_hardened_clay");

    public static final MapColor LIME = DummyObjectProvider.createFor(MapColor.class, "lime");

    public static final MapColor LIME_STAINED_HARDENED_CLAY = DummyObjectProvider.createFor(MapColor.class, "lime_stained_hardened_clay");

    public static final MapColor MAGENTA = DummyObjectProvider.createFor(MapColor.class, "magenta");

    public static final MapColor MAGENTA_STAINED_HARDENED_CLAY = DummyObjectProvider.createFor(MapColor.class, "magenta_stained_hardened_clay");
    ...
    public static final MapColor ORANGE_STAINED_HARDENED_CLAY = DummyObjectProvider.createFor(MapColor.class, "orange_stained_hardened_clay");

    public static final MapColor PINK = DummyObjectProvider.createFor(MapColor.class, "pink");

    public static final MapColor PINK_STAINED_HARDENED_CLAY = DummyObjectProvider.createFor(MapColor.class, "pink_stained_hardened_clay");

    public static final MapColor PURPLE = DummyObjectProvider.createFor(MapColor.class, "purple");

    public static final MapColor PURPLE_STAINED_HARDENED_CLAY = DummyObjectProvider.createFor(MapColor.class, "purple_stained_hardened_clay");
    ...
    public static final MapColor RED_STAINED_HARDENED_CLAY = DummyObjectProvider.createFor(MapColor.class, "red_stained_hardened_clay");
    ...
    public static final MapColor SILVER_STAINED_HARDENED_CLAY = DummyObjectProvider.createFor(MapColor.class, "silver_stained_hardened_clay");
    ...
    public static final MapColor WHITE_STAINED_HARDENED_CLAY = DummyObjectProvider.createFor(MapColor.class, "white_stained_hardened_clay");
    ...
    public static final MapColor YELLOW_STAINED_HARDENED_CLAY = DummyObjectProvider.createFor(MapColor.class, "yellow_stained_hardened_clay");
