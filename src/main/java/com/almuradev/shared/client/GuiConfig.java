 ...
 * All Rights Reserved.
 */
package com.almuradev.shared.client;
...
public interface GuiConfig {
    ...
    interface Location {
        ...
        ResourceLocation ALMURA_LOGO = new ResourceLocation(Constants.Plugin.ID, "textures/gui/almura_logo.png");
        ResourceLocation ALMURA_MAN = new ResourceLocation(Constants.Plugin.ID, "textures/gui/almura_man.png");
        ResourceLocation SPONGEPOWERED_LOGO = new ResourceLocation(Constants.Plugin.ID, "textures/gui/spongepowered_logo.png");
        ResourceLocation SPONGEPOWERED_SPONGIE = new ResourceLocation(Constants.Plugin.ID, "textures/gui/spongie.png");
        ResourceLocation GENERIC_AVATAR = new ResourceLocation(Constants.Plugin.ID, "textures/gui/skins/avatars/generic.png");
    }

    @SideOnly(Side.CLIENT)
    interface SpriteSheet {

        ResourceLocation ALMURA_LOCATION = new ResourceLocation(Constants.Plugin.ID, "textures/gui/gui.png");
