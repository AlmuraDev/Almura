...
public final class LeavesProcessor implements AbstractTreeProcessor {
    private static final ConfigTag TAG = ConfigTag.create(TreeConfig.LEAVES);
    ...
    public void processTagged(final ConfigurationNode config, final Tree.Builder builder) {
        builder.leaves(LazyBlockState.parse(config));
    }
}
