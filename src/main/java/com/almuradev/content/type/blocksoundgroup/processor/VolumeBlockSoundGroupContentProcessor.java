...
public final class VolumeBlockSoundGroupContentProcessor implements TaggedConfigProcessor<BlockSoundGroup.Builder, ConfigTag> {
    private static final ConfigTag TAG = ConfigTag.create(BlockSoundGroupConfig.VOLUME);
    ...
    public void processTagged(final ConfigurationNode config, final BlockSoundGroup.Builder builder) {
        whenRealDouble(config, builder::volume);
    }
}
