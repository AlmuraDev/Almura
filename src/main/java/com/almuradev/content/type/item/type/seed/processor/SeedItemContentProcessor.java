...
public interface SeedItemContentProcessor extends ItemContentProcessor<SeedItem, SeedItem.Builder> {

    interface AnyTagged extends SeedItemContentProcessor, TaggedConfigProcessor<SeedItem.Builder, ConfigTag> {
