...
public interface AbstractFoodProcessor extends ItemContentProcessor<FoodItem, FoodItem.Builder> {
    interface AnyTagged extends AbstractFoodProcessor, TaggedConfigProcessor<FoodItem.Builder, ConfigTag> {
    }
}
