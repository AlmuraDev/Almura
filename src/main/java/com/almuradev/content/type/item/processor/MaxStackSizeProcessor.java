...
public final class MaxStackSizeProcessor implements ItemContentProcessor.AnyTagged {
    private static final ConfigTag TAG = ConfigTag.create(ItemConfig.MAX_STACK_SIZE);
