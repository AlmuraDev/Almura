...
public final class SoundProcessor implements BlockContentProcessor.State.Any {
    ...
    @Inject
    private SoundProcessor(final SingleTypeExternalContentProcessor<BlockSoundGroup, BlockSoundGroup.Builder> bsg) {
        this.bsg = bsg;
    }
