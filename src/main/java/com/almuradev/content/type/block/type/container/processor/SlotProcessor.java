...
public final class SlotProcessor implements ContainerBlockContentProcessor.Tagged {
    private static final ConfigTag TAG = ConfigTag.create(ContainerBlockConfig.SLOTS);
