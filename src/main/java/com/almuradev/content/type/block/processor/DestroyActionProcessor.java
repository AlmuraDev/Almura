...
public final class DestroyActionProcessor implements BlockContentProcessor.State.Any {
    ...
    @Inject
    public DestroyActionProcessor(final MultiTypeExternalContentProcessor<ActionGenre, ActionContentType, ActionContentType.Builder<ActionContentType>> da) {
        this.da = da;
    }
