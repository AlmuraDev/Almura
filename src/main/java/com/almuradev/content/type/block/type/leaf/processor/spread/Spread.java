...
public final class Spread {
    ...
    public static final ConfigurationNodeDeserializer<Spread> PARSER = new ConfigurationNodeDeserializer<Spread>() {
        @Override
        public Optional<Spread> deserialize(final ConfigurationNode config) {
            if (config.isVirtual()) {
                return Optional.empty();
            }

            final ConfigurationNode chanceNode = config.getNode(SpreadConfig.CHANCE);
            ...
            final ConfigurationNode blockNode = config.getNode(SpreadConfig.BLOCK);
            ...
            return Optional.of(new Spread(biomeChancePredicates, globalChanceRange, state));
        }
    ...
    private Spread(final Map<FunctionPredicate<Biome, ResourceLocation>, DoubleRange> biomeChancePredicates,
