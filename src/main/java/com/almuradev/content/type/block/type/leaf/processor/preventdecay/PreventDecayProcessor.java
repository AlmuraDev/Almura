...
public final class PreventDecayProcessor implements LeafBlockContentProcessor.AnyState {
    ...
    public void processState(ConfigurationNode config, LeafBlock.Builder builder, LeafBlockStateDefinitionBuilder definition) {
        PreventDecay.PARSER.deserialize(config).ifPresent(definition::preventDecay);
    }
}
