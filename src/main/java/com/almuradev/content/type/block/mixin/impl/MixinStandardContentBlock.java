...
public abstract class MixinStandardContentBlock extends Block implements ContentBlockType {
    ...
    public AxisAlignedBB getBoundingBox(final IBlockState state, final IBlockAccess world, final BlockPos pos) {
        final BlockStateDefinition.Impl<?, ?, ?> definition = (BlockStateDefinition.Impl<?, ?, ?>) this.definition(state);
