...
public final class RequiresProcessor implements AbstractFlowerProcessor {

    private static final ConfigTag TAG = ConfigTag.create(FlowerGeneratorConfig.REQUIRES);
