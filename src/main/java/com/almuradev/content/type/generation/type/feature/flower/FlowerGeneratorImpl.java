...
public final class FlowerGeneratorImpl implements FlowerGenerator, Witness {
    private final List<String> worlds;
    private final List<DoubleRangeFunctionPredicatePair<Biome>> biomes;
    private final List<LazyBlockState> requires;
    private final Delegate<Flower> flower;

    FlowerGeneratorImpl(final List<String> worlds, final List<DoubleRangeFunctionPredicatePair<Biome>> biomes, final List<LazyBlockState> requires,
            final Delegate<Flower> flower) {
        this.worlds = worlds;
        this.biomes = biomes;
