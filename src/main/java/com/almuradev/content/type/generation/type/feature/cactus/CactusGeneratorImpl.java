...
public final class CactusGeneratorImpl implements CactusGenerator, Witness {
    private final List<String> worlds;
    private final List<DoubleRangeFunctionPredicatePair<Biome>> biomes;
    private final List<LazyBlockState> requires;
    private final Delegate<Cactus> cactus;

    CactusGeneratorImpl(final List<String> worlds, final List<DoubleRangeFunctionPredicatePair<Biome>> biomes, final List<LazyBlockState> requires,
            final Delegate<Cactus> cactus) {
        this.worlds = worlds;
        this.biomes = biomes;
